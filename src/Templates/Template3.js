...
<input  type="range" min="0" max="100" value={slide} className="range range-xs range-success relative bg-yellow-300 lg:w-[400px]"/>
        ...
        <div className="flex   justify-center w-[590px]  items-center">
          <div className="flex   flex-col justify-center items-center border-2 rounded-[20px] border-black gap-7 w-full h-[500px] ">
            <div
              id="resumepage"
            ...
            >
              ...
              <div className="flex m-3 flex-row gap-[50px] justify-start">
                <div className="flex flex-col justify-start">
                  <div className="flex flex-row justify-start">
                    <h1 className="text-xl uppercase text-start text-black font-bold p-1">
                      {valueB.fullname}
                    </h1>
              ...
              <div class=" flex flex-col m-1 ">
                <h1 class="sm:text-sm text- text-[17px] uppercase tracking-wide  font-bold text-black">
                  Experiance
                </h1>
                <div>
                  {valueC.map((key) => {
              ...
              <div class="  flex flex-col m-1">
                <div class=" flex flex-col  relative  items-start text-start">
                  <h1 class="title-f uppercase sm:text-sm text- text-[17px] w-[500px] tracking-wide p- font-bold text-black">
                    Education
                  </h1>
                  {valueD.map((key) => {
                    return (
              ...
              <div class="flex flex-col justify-start items-start">
                <div class="   flex flex-col  relative  items-start text-start">
                  <h1 class=" uppercase sm:text-sm text- text-[17px] tracking-wide p- font-bold text-black">
                    Projects
                  </h1>
                  {valueE.map((key) => {
                    return (
              ...
              <div class=" flex flex-col m-1 ">
                <div class=" md:w-2/3  flex flex-col  relative items-start text-start">
                  <h1 class="title-f  sm:text-sm uppercase text- text-[17px] w-[500px] tracking-wide p- font-bold text-black">
                    Additional courses
                  </h1>
