    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center mt-5 ">
        ...
        <div className="flex flex-col m-1 lg:gap-1 ">
          ...
          <div className="flex lg:block hidden flex-row m-1 gap-1">
            ...
            <input
              ...
              max="100"
              value={slide}
              className="range range-xs range-success relative bg-yellow-300 lg:w-[400px]"
            />
          </div>
        </div>
        ...
        <div className="flex   justify-center w-[590px]  items-center">
          <div className="flex  border-2 border-black rounded-[20px]  flex-col justify-center items-center  gap-7 w-full h-[500px] ">
            <div
              id="resumepage"
            ...
            >
              ...
              <div className="flex m-3 flex-row gap-[50px] justify-start">
                <div className="flex flex-col justify-start">
                  <div className="flex flex-row justify-start">
                    <h1 className="text-xl text-start text-green-500 font-bold p-1">
                      {valueB.fullname}
                    </h1>
              ...
              <div class=" flex flex-col m-1 ">
                <h1 class="sm:text-sm text- text-[17px] tracking-wide p- font-bold text-green-500">
                  Experiance
                </h1>
                <div>
                  {valueC.map((key) => {
              ...
              <div class="flex flex-row m-1 ">
                <div class="  grid grid-cols-4  ">
                  <h1 class=" sm:text-sm text- text-[17px]  tracking-wide  font-bold text-green-500">
                    Skills:
                  </h1>
              ...
              <div class="  flex flex-col m-1">
                <div class=" flex flex-col  relative  items-start text-start">
                  <h1 class="title-f w-[500px]ont sm:text-sm text- text-[17px] w-[500px] tracking-wide p- font-bold text-green-500">
                    Education
                  </h1>
                  {valueD.map((key) => {
                    return (
