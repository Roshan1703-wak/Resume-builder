          ...
          <div className="flex   flex-col justify-center items-center  border-2 border-black rounded-[20px]  gap-7 w-full h-[500px] ">
            ...
            >
              ...
              <div class=" flex flex-col m-1 ">
                <h1 class="sm:text-sm text-start underline text-[17px] tracking-wide p- font-bold text-blue-500">
                  Experiance
                </h1>
                <div className="m-2">
                  {valueC.map((key) => {
                    return (
                      <>
                        <p class=" text-sm leading-relaxed w-[500px] text-black ">
                          {key.company}-  {key.location} - {key.jobtit}-{key.jobtype}
                        </p>
                      
                        <p class=" text-xs leading-relaxed w-[500px] text-black ">
                        {key.discription}-{key.start}-{key.end}
                        </p>
                      </>
                    );
                  })}
              ...
              <div class="flex flex-row m-1 ">
                <div class="  grid grid-cols-4  ">
                  <h1 class=" sm:text-sm text- text-[17px] text-start underline tracking-wide  font-bold text-blue-500">
                    Skills:
                  </h1>
              ...
              <div class="  flex flex-col m-1">
                <div class=" flex flex-col  relative  items-start text-start">
                  <h1 class="title-f text-start underline w-[500px]ont sm:text-sm text- text-[17px] w-[500px] tracking-wide p- font-bold text-blue-500">
                    Education
                  </h1>
                  {valueD.map((key) => {
                    return (
                      <>
                        <p class=" text-sm leading-relaxed w-[500px] text-black ">
                          {key.collage}-{key.course} -{key.locationed}-{key.cgpa}
                        </p>
              ...
              {/*   Project info  Start   */}
                ...
                <div class="   flex flex-col ">
                  <h1 class=" text-start underline sm:text-sm  text-[17px] tracking-wide  font-bold text-blue-500">
                    Projects
                  </h1>
                  {valueE.map((key) => {
                    return (
              ...
              <div class=" flex flex-col m-1 ">
                <div class=" md:w-2/3  flex flex-col  relative items-start text-start">
                  <h1 class="title-f text-center underline w-[500px]ont sm:text-sm text- text-[17px] w-[500px] tracking-wide p- font-bold text-blue-500">
                    Additional courses
                  </h1>
